    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style_preference', models.CharField(blank=True, choices=[('casual', 'Casual'), ('formal', 'Formal'), ('streetwear', 'Streetwear'), ('business', 'Business'), ('sporty', 'Sporty'), ('bohemian', 'Bohemian'), ('minimalist', 'Minimalist')], default='casual', max_length=30)),
